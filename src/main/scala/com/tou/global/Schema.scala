...
object Schema {
  val videoCameraItemsDetected: StructType = StructType(List(
  ...
  val geolocation: StructType = StructType(List(
    StructField("geographical_location_oid", LongType, nullable = false),
    StructField("geographical_location", StringType, nullable = false)
  ))

  val videoCameraItemsDetectedByLocation: StructType = videoCameraItemsDetected.add(StructField("geographical_location", StringType, nullable = true))

  val itemNameByCount: StructType = StructType(List(
    StructField("item_name", StringType, nullable = false),
